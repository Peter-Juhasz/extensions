...
public class UriTests
{
	...
	public void Uri_AppendQueryString_First_Null() =>
		Assert.AreEqual(new Uri("https://example.org"), new Uri("https://example.org").AppendQueryString("a", null as int?));
	...
	public void Uri_AppendQueryString_Second_Null() =>
		Assert.AreEqual(new Uri("https://example.org/?a=b"), new Uri("https://example.org/?a=b").AppendQueryString("b", null as int?));
